...
export const INITIAL_STAFF: Staff[] = [
  ...
  { id: 'S002', fullName: 'Atwine Patience', role: 'Class Teacher', phone: '+256 703 668822', salaryUGX: 800000, assignedClass: 'Baby Class', photoUrl: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=250&h=250&q=80' },
  { id: 'S003', fullName: 'Apio Martha', role: 'Class Teacher', phone: '+256 782 119955', salaryUGX: 800000, assignedClass: 'Middle Class', photoUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=250&h=250&q=80' },
  { id: 'S004', fullName: 'Okurut Daniel', role: 'Class Teacher', phone: '+256 754 332211', salaryUGX: 850000, assignedClass: 'Top Class', photoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=250&h=250&q=80' },
  { id: 'S005', fullName: 'Nakitende Proscovia', role: 'Nursery Caretaker', phone: '+256 701 440022', salaryUGX: 500000, assignedClass: 'Baby Class', photoUrl: 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?auto=format&fit=crop&w=250&h=250&q=80' },
...
export const INITIAL_REPORTS: ECDReport[] = [
  {
    ...
    headTeacherComments: 'A solid and promising start for Shifra in Baby Class. Keep up the enthusiasm!',
  ...
  },
  {
    ...
    headTeacherComments: 'Excellent social-emotional progress! Kato is an absolute joy to have in Baby Class.',
...
export const INITIAL_MISC_INCOME: MiscellaneousIncome[] = [
  {
    ...
    center: 'Stationery & Uniforms Store',
    notes: 'Sold to new Baby Class parents on Wednesday admission.'
  },
  {
    id: 'MI002',
