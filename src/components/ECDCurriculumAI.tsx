...
export default function ECDCurriculumAI() {
  ...
  const [gradeLevel, setGradeLevel] = useState('Baby Class (3-4 yrs)');
  ...
  useEffect(() => {
    if (category === 'ECD') {
      setGradeLevel('Baby Class (3-4 yrs)');
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    {category === 'ECD' ? (
                      <>
                        <option value="Baby Class (3-4 yrs)">Baby Class (3-4 yrs)</option>
                        <option value="Middle Class (4-5 yrs)">Middle Class (4-5 yrs)</option>
                        <option value="Top Class (5-6 yrs)">Top Class (5-6 yrs)</option>
                      </>
                    ) : (
                      <>
