...
const INITIAL_LESSONS: Lesson[] = [
  { id: 'L1', className: 'Baby Class', subjectName: 'Pre-Maths (Classification)', teacher: 'Tr. Agnes', day: 'Monday', timeSlot: '08:30 AM - 09:30 AM', room: 'Block A Room 1' },
  { id: 'L2', className: 'Baby Class', subjectName: 'Phonics & Speech Sounds', teacher: 'Tr. Martha', day: 'Tuesday', timeSlot: '09:30 AM - 10:30 AM', room: 'Block A Room 1' },
  { id: 'L3', className: 'Middle Class', subjectName: 'Pre-Maths (Counting blocks)', teacher: 'Tr. Martha', day: 'Monday', timeSlot: '08:30 AM - 09:30 AM', room: 'Garden Tent' },
  { id: 'L4', className: 'Top Class', subjectName: 'Luganda Folk Songs & Play', teacher: 'Tr. Florence', day: 'Wednesday', timeSlot: '11:00 AM - 12:00 PM', room: 'Assembly Hall' },
];
...
export function AcademicTimetable() {
  ...
  const [newClass, setNewClass] = useState<NurseryClass>('Baby Class');
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-[#E0D8CC] overflow-hidden p-6 space-y-4">
          ...
          <div className="flex flex-wrap gap-1.5 pb-1">
            {(['All', 'Baby Class', 'Middle Class', 'Top Class', 'Primary One', 'Primary Two', 'Primary Three', 'Primary Four', 'Primary Five', 'Primary Six', 'Primary Seven'] as const).map((cl) => (
              <button
                key={cl}
