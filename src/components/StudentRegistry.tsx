...
import { Search, UserPlus, GraduationCap, Phone, MapPin, CheckCircle, XCircle, Edit, Save, Plus, X, Camera, Upload, Trash2, Bus, Clock, List, Grid } from 'lucide-react';
...
export function StudentRegistry({ pupils, onAddPupil, onUpdatePupil, onDeletePupil, globalSearchTerm }: StudentRegistryProps) {
  ...
  const [classLevel, setClassLevel] = useState<NurseryClass>('Baby Class');
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white p-4 rounded-3xl border border-[#E0D8CC]">
        <div className="flex-1 flex flex-col md:flex-row gap-3">
          ...
          <div className="flex gap-2">
            {(['All', 'Baby Class', 'Middle Class', 'Top Class', 'Primary One', 'Primary Two', 'Primary Three', 'Primary Four', 'Primary Five', 'Primary Six', 'Primary Seven'] as const).map((lvl) => (
              <button
            ...
            <form onSubmit={handleAddSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    <option value="Baby Class">Baby Class (3-4 Yrs)</option>
                    <option value="Middle Class">Middle Class (4-5 Yrs)</option>
                    <option value="Top Class">Top Class (5-6 Yrs)</option>
